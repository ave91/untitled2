...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_calibration_t, stringdata) + ofs \
...
const QMetaObject calibration::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_calibration.data,
...
void *calibration::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_calibration.stringdata))

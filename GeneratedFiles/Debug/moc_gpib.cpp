...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_gpib_t, stringdata) + ofs \
...
const QMetaObject gpib::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_gpib.data,
...
void *gpib::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gpib.stringdata))
